...
OUTPUT_DIR = "../15_Apr/vignettes_infectous/results_gemma4"
...
print(
    f"Starting Gemma 4 inference for {len(mapping)} images using {MODEL_ID}. Doing {N_COMPLETIONS} runs per prompt."
)
