...
OUTPUT_DIR = "../15_Apr/vignettes_infectous/results_qwen25"
...
print(
    f"Starting Qwen inference for {len(mapping)} images using {MODEL_ID}. Doing {N_COMPLETIONS} runs per prompt."
)
